...
- Responsibilities: Onboarding gate (`@AppStorage("today.hasCompletedOnboarding")`), 4-tab layout (Today, History, center + button, Settings), center record button intercept via `Binding<AppTab>`
